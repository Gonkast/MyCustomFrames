...
globals = {
    ...
    "SLASH_MCFMINIMAPBTNSRESET1", "SLASH_MCFMINIMAPBTNSLIST1", "SLASH_MCFMINIMAPBTNSIGNORE1",
    "SLASH_MCFSCALEDUMP1", "SLASH_MCFBT4DIAG1",
    "SLASH_MCFDIAG1", "SLASH_MCFSKINCHECK1", "SLASH_MCFUNDO1", "SLASH_MCFMENUDIAG1",
}
