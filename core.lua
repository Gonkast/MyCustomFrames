...
local function FillDefaults()
    ...
    if ns.MinimapButtonsDefaults then
        db.minimapbuttons = db.minimapbuttons or {}
        FillProfile(db.minimapbuttons, ns.BUILTIN and ns.BUILTIN.minimapbuttons, ns.MinimapButtonsDefaults())
    end
...
local function HideArenaFramesNow()
    ...
    -- nivel mas adentro (bisnieto). Se sube a depth=4 para estos 3 contenedores
    -- especificamente -- misma tecnica ya confirmada segura (100% alpha, ver
    -- HB_HideAlphaDeep), solo mas nesting cubierto.
    HB_HideAlphaDeep(_G.ArenaEnemyFrames, 4)
    HB_HideAlphaDeep(_G.CompactArenaFrame, 4)
    HB_HideAlphaDeep(_G.PreMatchFramesContainer, 4)
    for i = 1, 5 do
        HB_HideAlphaDeep(_G["ArenaEnemyFrame" .. i], 4)          -- alias legacy, nil-safe
